...
abstract class AppColors {
  ...
  static const Color statusBarColor = Color(0xFF0ABCE4);
  static const Color appBarColor = Color(0xFF0ABCE4);
  ...
  static const Color colorPrimary = Color(0xFF0ABCE4);
  static const Color colorAccent = Color(0xFF0ABCE4);
  ...
  static const Color textColorCyan = Color(0xFF0ABCE4);
  static const Color textColorWhite = Color(0xFFFFFFFF);
  static Color searchFieldTextColor = const Color(0xFF0ABCE4).withOpacity(0.5);

  static const Color iconColorDefault = Colors.grey;

  static Color barrierColor = const Color(0xFF000000).withOpacity(0.5);

  static Color timelineDividerColor = const Color(0xFF0ABCE4);
